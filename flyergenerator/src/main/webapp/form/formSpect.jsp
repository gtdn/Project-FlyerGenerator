...
<form method="GET" action="validation.jsp">
    ...
    <div class="form-group">
        <label for="nameAsso">Nom association</label>
        <input type="text" class="form-control" id="nameAsso">
    </div>
    <div class="form-group">
        <label for="nameArtiste">Artistes</label>
        <input type="text" class="form-control" id="nameArtiste">
    </div>
    <div class="form-group">
